      ...
      <nav className="fixed top-0 left-0 right-0 h-20 bg-background/80 backdrop-blur-md z-50 border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 font-medium text-slate-300">
            ...
            <Link
              href="/app/emergency"
              className="text-emergency hover:text-emergency-foreground transition-colors"
            >
              Emergency
            </Link>
            <Link href="/app/facilities" className="hover:text-white transition-colors">
              Facilities
            </Link>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-400 mb-10 max-w-lg leading-relaxed">
                ...
                options you can act on. Powered by evidence-first data infrastructure.
              </p>
              ...
              <div className="relative glass-panel rounded-2xl border border-border shadow-2xl overflow-hidden bg-neutral-950">
                <div className="p-4 border-b border-border bg-neutral-900 flex items-center gap-3">
                  ...
                  <span className="text-white font-medium">
                    Need emergency trauma care in Lucknow
                  </span>
                </div>
                <div className="p-6 space-y-4">
                  ...
                  <div className="bg-neutral-900 border border-emergency/30 rounded-lg p-4 shadow-[0_0_15px_rgba(225,29,72,0.05)] relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="text-xs font-bold text-emergency bg-emergency/10 px-2 py-1 rounded">
                        2.4 km away
                      </span>
                    </div>
                    <div className="flex gap-2 mb-3">
                      <span className="text-xs bg-neutral-800 text-slate-300 px-2 py-1 rounded border border-neutral-700">
                        Emergency Hospital
                      </span>
                      <span className="text-xs bg-neutral-800 text-slate-300 px-2 py-1 rounded border border-neutral-700">
                        Trauma Centre
        ...
        <section id="how-it-works" className="py-24 bg-neutral-950 border-t border-border">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-slate-400 mb-16 leading-relaxed">
              When you need care, answers are scattered across hospital websites, government
              portals, public directories, and specialty pages. Finding what you need shouldn't be a
              research project.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 text-lg">
                We turn chaos into clear, actionable intelligence.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8 relative">
              ...
              {[
                ...
                {
                  title: 'Intelligence',
                  desc: 'Matches capabilities, not just keywords.',
                  icon: Zap,
                },
                {
                  title: 'Verified Options',
                  desc: 'Ranked results with evidence.',
                  icon: CheckCircle,
                },
              ].map((step, i) => (
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="glass-panel p-8 rounded-2xl border border-border">
                ...
                <div className="space-y-3 font-mono text-sm bg-neutral-950 p-4 rounded border border-neutral-800 overflow-hidden">
                  ...
                  <div className="pl-4">
                    <span className="text-teal-400">"facility_name"</span>:{' '}
                    <span className="text-amber-300">"City Hospital"</span>,
                  </div>
                  <div className="pl-4">
                    <span className="text-teal-400">"emergency_available"</span>:{' '}
                    <span className="text-purple-400">true</span>,
                  </div>
                  <div className="pl-4">
                    <span className="text-teal-400">"departments"</span>:{' '}
                    <span className="text-slate-400">["Cardiology", "Neurology"]</span>
                  </div>
                  <div className="text-slate-500">{'}'}</div>
                </div>
              </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-slate-400 mb-6 leading-relaxed">
                CareRoute can onboard facilities that are difficult to discover or structurally
                inconsistent. Powered by Bright Data's AI Flow, we convert unstructured hospital
                websites into verified JSON schemas autonomously.
              </p>
              <ul className="space-y-4 text-slate-300">
                <li className="flex items-center gap-3">
                  <CheckCircle className="text-green-500" size={20} />{' '}
                  <span>Website unstructured data</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="text-green-500" size={20} />{' '}
                  <span>AI schema extraction & validation</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="text-green-500" size={20} />{' '}
                  <span>Structured CareRoute intelligence</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="py-24 bg-neutral-950 border-t border-b border-border">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-slate-400 leading-relaxed mb-12">
              Websites change. Departments move. When a data extraction fails due to a layout shift,
              CareRoute detects the anomaly, autonomously triggers a healing process, repairs the
              scraper, and restores the data—without human intervention.
            </p>
            <div className="flex items-center justify-center gap-4 font-mono text-sm">
              <span className="bg-neutral-900 px-3 py-1 rounded text-slate-300">
                Website Changes
              </span>
              <ArrowRight className="text-slate-600" size={16} />
              <span className="bg-red-500/10 text-red-500 px-3 py-1 rounded border border-red-500/30">
                Extraction Failure
              </span>
              <ArrowRight className="text-slate-600" size={16} />
              <span className="bg-amber-500/10 text-amber-500 px-3 py-1 rounded border border-amber-500/30">
                AI Repair
              </span>
              <ArrowRight className="text-slate-600" size={16} />
              <span className="bg-green-500/10 text-green-500 px-3 py-1 rounded border border-green-500/30">
                Data Restored
              </span>
            </div>
          </div>
        ...
        <section className="py-32 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-6">
            ...
            <Link href="/app/search">
              <Button
                size="lg"
                className="text-lg px-12 py-6 rounded-full shadow-2xl shadow-brand/20"
              >
                Enter CareRoute
              </Button>
            </Link>
