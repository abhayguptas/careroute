...
import { Activity, Database, CheckCircle2, AlertTriangle, RefreshCw, ChevronRight } from 'lucide-react';
...
export default function ScraperHealthPage() {
  ...
  const scrapers = [
    { id: 'c_8f7d6a5b', name: 'Fortis Hospital Delhi', status: 'healthy', lastRun: '2 hours ago', freshness: '100%', target: 'https://fortishealthcare.com/...' },
    { id: 'c_9a2b3c4d', name: 'Apollo Spectra', status: 'broken', lastRun: '1 day ago', freshness: '65%', target: 'https://apollo.com/...' },
    { id: 'c_1e2f3g4h', name: 'Max Super Speciality', status: 'healing', lastRun: 'Just now', freshness: 'N/A', target: 'https://maxhealthcare.in/...' }
  ];
    ...
    <div className="max-w-6xl mx-auto pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-neutral-950 border border-border rounded-xl p-6 shadow-sm">
          <div className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-2">Total Collectors</div>
          <div className="text-3xl font-bold text-white">42</div>
        </div>
        <div className="bg-neutral-950 border border-border rounded-xl p-6 shadow-sm">
          <div className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-2">Healthy</div>
          <div className="text-3xl font-bold text-green-500 flex items-center gap-2">39 <CheckCircle2 size={24}/></div>
        </div>
        <div className="bg-neutral-950 border border-emergency/30 rounded-xl p-6 shadow-[0_0_15px_rgba(225,29,72,0.05)]">
          <div className="text-sm font-bold text-emergency uppercase tracking-wider mb-2">Needs Attention</div>
          <div className="text-3xl font-bold text-white flex items-center gap-2">2 <AlertTriangle size={24} className="text-emergency"/></div>
        </div>
        <div className="bg-neutral-950 border border-amber-500/30 rounded-xl p-6 shadow-sm">
          <div className="text-sm font-bold text-amber-500 uppercase tracking-wider mb-2">AI Healing</div>
          <div className="text-3xl font-bold text-white flex items-center gap-2">1 <RefreshCw size={24} className="text-amber-500 animate-spin-slow"/></div>
        </div>
      </div>
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="space-y-6 flex-1">
                  ...
                  <div className="relative pl-6 border-l-2 border-neutral-800 pb-2">
                    ...
                    <p className="text-xs text-slate-500">10:45 AM • Missing field: emergency_hours</p>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-sm">
                  <div className="bg-neutral-900 p-3 rounded">
                    ...
                    <span className="text-brand truncate block">{scrapers.find(s => s.id === selectedScraper)?.target}</span>
                  </div>
                  <div className="bg-neutral-900 p-3 rounded">
