            ...
            <div className="space-y-4 border-t border-border pt-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <span className="text-sm text-slate-300 bg-neutral-900 px-2 py-1 rounded">
                    {intent.city}
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            {results.length > 0 && (
              <div className="text-center py-8 border-t border-border mt-8">
                ...
                <Button variant="secondary" onClick={() => router.push('/app/onboard')}>
                  Add a new facility to CareRoute
                </Button>
              </div>
            )}
          </div>
