      ...
      <div className="space-y-6">
        ...
        <section className="bg-neutral-950 border border-border rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-slate-300 mb-2">Default Search Location</label>
              <input 
                type="text" 
            ...
            <div className="flex items-center justify-between py-2">
              <div>
                ...
                <div className="text-sm text-slate-500">Allow CareRoute to use your device GPS for emergency routing.</div>
              </div>
        ...
        <section className="bg-neutral-950 border border-border rounded-xl p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-slate-300 mb-2">Primary Emergency Service</label>
        ...
        <section className="bg-neutral-950 border border-border rounded-xl p-6">
          ...
          <div className="space-y-4">
             <p className="text-sm text-slate-400 mb-4">CareRoute does not store personal medical information. Search history is stored locally on your device.</p>
             <Button variant="outline" className="text-red-400 border-red-900/30 hover:bg-red-900/20">Clear Local Search History</Button>
          </div>
        </section>
      </div>
    </div>
