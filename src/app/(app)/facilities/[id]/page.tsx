...
import { Building2, MapPin, Phone, ExternalLink, ArrowLeft, Clock, ShieldCheck, Database, Calendar } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl lg:text-4xl font-bold text-white tracking-tight">Fortis Escorts Heart Institute</h1>
            <Badge variant="outline" className="bg-blue-900/20 text-blue-400 border-blue-900/30">Private</Badge>
            <Badge variant="success"><ShieldCheck size={12} className="mr-1"/> Verified</Badge>
          </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card>
              <CardContent className="p-0">
                <div className="grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-border">
                  <div className="p-6">
                    <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4">Departments</h3>
                  ...
                  <div className="p-6">
                    <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4">Services</h3>
                    <ul className="space-y-3">
        ...
        <div className="space-y-6">
          <Card className="bg-neutral-950">
            <CardHeader>
              <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider">Quick Info</h3>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="#" className="text-sm text-brand hover:underline flex items-center gap-1">
